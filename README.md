...
| 02 | [DB 스키마 & 데이터 모델](docs/plans/02-database-schema.md) | ✅ 완료 (v4, 2026-02-11) |
...
| 06 | [UI/UX 테마 & 디자인 시스템](docs/plans/06-ui-theme.md) | ✅ 완료 (v4, 2026-02-11) |
| 07 | [모노레포 설계](docs/plans/07-monorepo-setup.md) | ✅ 완료 (v5, 2026-02-11) |
